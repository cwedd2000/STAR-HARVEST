...
"Al Fredo");
	if dex>300 and dex <600 {
		...
		draw_text_color(x-350,y-120,"- # HOLD W # -Use your rocket accelerator and drill a goddamn hole into that station below you NOW!%$!#.....",c_yellow,c_yellow,c_yellow,c_yellow,1);}
