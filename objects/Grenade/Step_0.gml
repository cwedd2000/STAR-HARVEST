...
t+=1;
if t<10{vspeed+=.5;}
if t>10{vspeed+=.1;image_xscale=random_range(.1,1.8);image_yscale=image_xscale;sprite_index=s_boom;audio_sound_gain(snd_blast1,.06,0);audio_play_sound(snd_blast1,1,0);audio_sound_gain(snd_blast1,0,1);direction=random(180);}
...
MoveY= -MoveY / 2;vspeed-=.025;image_alpha-=.001;}
// Same for horizontal
if place_meeting(x,y,obj_solid1){
MoveX = -MoveX / 2;vspeed-=.025;image_alpha-=.001;}if image_alpha<0{instance_destroy();}
