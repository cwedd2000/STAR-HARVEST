...
hp-=.6*de.speed;	image_blend=make_color_hsv(255,irandom_range(180,255)-da,irandom_range(170,255)-da);
}
if place_meeting(x,y,o_bulletsa){
	
hp-=2*ze.speed;	image_blend=make_color_hsv(255,irandom_range(180,255)-da,irandom_range(170,255)-da);
}
if place_meeting(x,y,o_bulletsv){
	
hp-=.8*le.speed;	image_blend=make_color_hsv(255,irandom_range(180,255)-da,irandom_range(170,255)-da);
}
if place_meeting(x,y,o_bulletsp){
	
hp-=.6*ge.speed;	image_blend=make_color_hsv(255,irandom_range(180,255)-da,irandom_range(170,255)-da);
}
if place_meeting(x,y,o_bulletsenem) or place_meeting(x,y,o_turr){
	hp-=1;image_blend=make_color_hsv(255,irandom_range(180,255)-da,irandom_range(170,255)-da);
...
if collision_circle(x,y,28,o_enem,1,1){hp-=random(1.42);image_blend=make_color_hsv(random(5),irandom_range(130,255)-da,irandom_range(170,255)-da);}
