...
if collision_circle(x,y,18,o_play,1,1){hp-=random(.8);image_blend=make_color_hsv(random(2),irandom_range(130,255),irandom_range(170,255));}
...
if place_meeting(x,y,o_walldeb11){
	hp-=(.1+.7*random(1.9))*other.image_xscale;image_blend=make_color_hsv(irandom_range(1,30),irandom_range(130,255),irandom_range(170,255));	
}