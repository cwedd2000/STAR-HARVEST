...
if place_meeting(x,y,o_walldeb1) or place_meeting(x,y,o_walldeb11){
		hp-=(.2+.5*random(1.8));image_blend=make_color_hsv(20,irandom_range(180,215),irandom_range(70,255));
}

if place_meeting(x,y,o_walldeb) or place_meeting(x,y,o_walldeb2) {hp-=(.1+.1*random(.1));image_blend=make_color_hsv(0,0,irandom_range(140,255));}