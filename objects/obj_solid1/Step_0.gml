...
if  collision_circle(x,y,18,o_play,1,1){hp-=(.2+.1*random(.1))/distance_to_object(o_play);image_blend=make_color_hsv(random(255),random(255),irandom_range(70,255));}


if hp<0{instance_destroy();}
if place_meeting(x,y,o_walldeb1) or place_meeting(x,y,o_walldeb11){
		hp-=(.01+.7*random(1.5));image_blend=make_color_hsv(random(255),255,irandom_range(50,255));
}
if place_meeting(x,y,o_walldeb) or place_meeting(x,y,o_walldeb2) {hp-=(.01+1*random(.1));image_blend=make_color_hsv(random(155),255,irandom_range(10,255));}